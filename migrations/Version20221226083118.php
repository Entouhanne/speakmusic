 ...
 */
final class Version20221226083118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE musique (id INT AUTO_INCREMENT NOT NULL, id_auteur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_EE1D56BCE08ED3C1 (id_auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
